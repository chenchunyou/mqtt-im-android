...
public class CustomExpandableListView extends ExpandableListView implements AbsListView.OnScrollListener, ExpandableListView.OnGroupClickListener, ExpandableListView.OnGroupCollapseListener, ExpandableListView.OnGroupExpandListener {
    ...
    public boolean onGroupClick(ExpandableListView parent, View v, int groupPosition, long id) {
        if (collapsEnable) {
            if (getGroupClickStatus(groupPosition) == 0) {
                ...
                /*ImageView groupStatusImg = v.findViewById(R.id.group_status_img);
                groupStatusImg.setImageResource(R.drawable.dh7);*/

            } else if (getGroupClickStatus(groupPosition) == 1) {
                setGroupClickStatus(groupPosition, 0);
                parent.collapseGroup(groupPosition);
                /*ImageView groupStatusImg = v.findViewById(R.id.group_status_img);
                groupStatusImg.setImageResource(R.drawable.dh6);*/
            }
        }
        return true;
    }
